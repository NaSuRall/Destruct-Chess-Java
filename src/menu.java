...
public class menu {
    public static void menu() {
        ...
        while (true) {
            System.out.println("Welcome! To choose an option, tap a number ");
            ...
            try {
                ...
                switch (choix) {
                    ...
                    case 2:
                        ...
                        System.out.println("During his turn a player can move his pawn one space (vertically or\n" +
            ...
            } catch (NumberFormatException e) { // Correction ici
